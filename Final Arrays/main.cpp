...
int main() {
	...
	std::cout << std::endl; //перено курсора на следующую строку в консоле и очищение буфера потока вывода
	...
	std::cout << "Средн. = " <<
		double(sum)/size2 << "\nКол-во чисел, следующих условию = " <<
		counter << "\n\n";
	std::cout << "Кол-во чисел, следующих условию = " <<
		counter << std::endl;
